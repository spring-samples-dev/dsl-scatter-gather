...
public class MainFlowConfiguration {
    ...
    private final MessageChannel myLogChannel;

    public MainFlowConfiguration(OrderAggregator orderAggregator,
                                 @Qualifier("myLogQueue") MessageChannel myLogChannel,
        ...
        this.myLogChannel = myLogChannel;
    }
    ...
    public MessageChannel output() {
        return MessageChannels
                .executor("output-flow", outputExecutor())
                .interceptor(new WireTap(myLogChannel))
                .get();
    }
    ...
    public MessageChannel input() {
        return MessageChannels
                .executor("input-flow", inputExecutor())
                .get();
    }
    ...
    private MessageHandler gatherer() {
        ...
        return new AggregatingMessageHandler(
                new MethodInvokingMessageGroupProcessor(orderAggregator),
